...
INSERT INTO dishes (name, date, price, restaurant_id) VALUES
  ('soup1', '2018-06-06', 500.99, 100010),
  ('salad1', '2018-06-06', 500.99, 100010),
  ('coffee1', '2018-06-06', 500.99, 100010),
  ('soup2', '2018-06-06', 500.99, 100011),
  ('salad2', '2018-06-06', 500.99, 100011),
  ('coffee2', '2018-06-06', 500.99, 100011),
